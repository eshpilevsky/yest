...
<div>
    <div class="desktop-mode">
        <div class="rest-cotainer">
            <div class="left">
                <div class="left-top" :style="{backgroundImage:'url(https://img.yest.by/resize/restaurant/900/'+restuarant.background_image+')'}">
                            ...
                            <v-card v-if="item !== null" class="dish-card">
                                <div @click="showSelectedDish(item)">
                                    <div class="card-dish-top">
                                        ...
                                        <img :src="'https://img.yest.by/resize/dish/400/'+item.image" :alt="item.name" class="dish-img-mobile" />
                                    </div>
                        ...
                        <v-card-text class="pa-0 bgGray">
                            <div class="mobile-addition__top">
                                ...
                                <div class="selected-dish-top">
                                    <img :src="'https://img.yest.by/resize/dish/400/'+selectedDish.image" :alt="selectedDish.name" class="dish-img-mobile-selected" />
                                </div>
