      ...
      <div class="form-fields">
        ...
        <div class="form-fields__grid-wrapper">
          <div class="form-fields__container">
            ...
            <v-text-field class="form-input" type="srting" v-model="delivery.room" placeholder="" required
                          outlined></v-text-field>
          </div>
          <div class="form-fields__container">
            <p class="form-fields__label">Домофон</p>
            <v-text-field class="form-input" type="srting" v-model="delivery.intercom" placeholder="" required
                          outlined></v-text-field>
          </div>
          <div class="form-fields__container">
            <p class="form-fields__label">Этаж</p>
            <v-text-field class="form-input" type="srting" v-model="delivery.flor" placeholder="" required
                          outlined></v-text-field>
          </div>
          <div class="form-fields__container">
            <p class="form-fields__label">Подъезд</p>
            <v-text-field class="form-input" type="srting" v-model="delivery.enterence" placeholder="" required
                          outlined></v-text-field>
          </div>
        </div>
        <div class="form-fields__container">
          <p class="form-fields__label">Комментарий к заказу</p>
          <v-textarea class="form-textarea" name="comment" dense max-height="50px" v-model="comment"
